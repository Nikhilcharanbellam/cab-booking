...
public class AddintercityDriver extends JFrame {
    private JPanel contentPane;
	private JTextField t1,t2,t3,t4,t6,t7;
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
                    try {
                        AddintercityDriver frame;
                        frame = new AddintercityDriver("");
	...
	public AddintercityDriver(String username) throws SQLException {
		...
		l4.setBounds(35, 200, 200, 14);
		contentPane.add(l4);
                
                t4 = new JTextField();
		t4.setBounds(271, 200, 150, 20);
		contentPane.add(t4);
		t4.setColumns(10);
		...
		t2 = new JTextField();
		t2.setBounds(271, 250, 150, 20);
		contentPane.add(t2);
		t2.setColumns(10);

          
		JLabel lblCountry = new JLabel("Destination :");
		lblCountry.setBounds(35, 300, 200, 14);
		contentPane.add(lblCountry);
                
                t3 = new JTextField();
		t3.setBounds(271, 300, 150, 20);
		contentPane.add(t3);
		t3.setColumns(10);
