...
public class BookCab extends JFrame{      
	...
	c2 = new Choice();
        ...
        try{
            ...
            try (ResultSet rs = c.stm.executeQuery("select * from intracity")) {
                while(rs.next()){
	...
	add(l8);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab_booking/images/intracab.png"));
