...
public class ViewTruckingDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewTruckingDetails frame = new ViewTruckingDetails("username");
	...
	public ViewTruckingDetails(String username)  {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab_booking/images/viewtrucking.jpg"));
		...
		contentPane.add(l8);
                ...
                try{
                    ...
                    rs = c.stm.executeQuery("select * from intratransport where name = '"+name+"'");
                    while(rs.next()){
